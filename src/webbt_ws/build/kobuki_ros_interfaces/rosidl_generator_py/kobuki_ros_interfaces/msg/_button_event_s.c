...
bool kobuki_ros_interfaces__msg__button_event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kobuki_ros_interfaces.msg._button_event.ButtonEvent", full_classname_dest, 51) == 0);
  }
  kobuki_ros_interfaces__msg__ButtonEvent * ros_message = _ros_message;
  {  // button
...
PyObject * kobuki_ros_interfaces__msg__button_event__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("kobuki_ros_interfaces.msg._button_event");
