...
bool kobuki_ros_interfaces__msg__digital_output__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kobuki_ros_interfaces.msg._digital_output.DigitalOutput", full_classname_dest, 55) == 0);
  }
  kobuki_ros_interfaces__msg__DigitalOutput * ros_message = _ros_message;
  {  // values
...
PyObject * kobuki_ros_interfaces__msg__digital_output__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("kobuki_ros_interfaces.msg._digital_output");
