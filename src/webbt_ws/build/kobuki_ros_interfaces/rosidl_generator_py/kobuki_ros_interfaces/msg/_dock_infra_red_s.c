...
bool kobuki_ros_interfaces__msg__dock_infra_red__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kobuki_ros_interfaces.msg._dock_infra_red.DockInfraRed", full_classname_dest, 54) == 0);
  }
  kobuki_ros_interfaces__msg__DockInfraRed * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of DockInfraRed */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("kobuki_ros_interfaces.msg._dock_infra_red");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DockInfraRed");
